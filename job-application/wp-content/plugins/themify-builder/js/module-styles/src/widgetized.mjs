    ...
    static get_styles() {
            ...
            this.get_expand('f', [
                this.get_tab({
                    ...
                    h: [
                        ...
                        this.get_color('', 'f_c', null, null, 'h'),
        ...
        widgetizedContainer = [
            ...
            this.get_expand('bg', [
                this.get_tab({
                    n: [
                        this.get_color(' .widget', 'b_c_c', 'bg_c', 'background-color')
                    ],
                    h: [
                        this.get_color(' .widget', 'b_c_c', 'bg_c', 'background-color', 'h')
                    ]
                })
            ]),
            // Padding
            this.get_expand('p', [
                this.get_tab({
                    n: [
                        this.get_padding(' .widget', 'p_c')
                    ],
                    h: [
                        this.get_padding(' .widget', 'p_c', 'h')
                    ]
                })
            ]),
            // Margin
            this.get_expand('m', [
                this.get_tab({
                    n: [
                        this.get_margin(' .widget', 'm_c')
                    ],
                    h: [
                        this.get_margin(' .widget', 'm_c', 'h')
                    ]
                })
            ]),
            // Border
            this.get_expand('b', [
                this.get_tab({
                    n: [
                        this.get_border(' .widget', 'b_c')
                    ],
                    h: [
                        this.get_border(' .widget', 'b_c', 'h')
                    ]
                })
            ])
        ],
        ...
        return {
            ...
            options: {
                ...
                widgett: widgetizedTitle,
                widgetc: widgetizedContainer
            }
        };
    }
}