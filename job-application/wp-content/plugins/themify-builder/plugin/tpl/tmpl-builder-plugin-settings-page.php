<div id="tb_panel">
    ...
    <link href="<?php echo THEMIFY_BUILDER_URI.'/plugin/css/builder-plugin-settings-page.css'?>?ver=<?php echo THEMIFY_VERSION ?>" rel="stylesheet"/>
    <link href="<?php echo THEMIFY_URI.'/css/admin/form.css'?>?ver=<?php echo THEMIFY_VERSION ?>" rel="stylesheet"/>
    <div class="container">
        <div class="header">
