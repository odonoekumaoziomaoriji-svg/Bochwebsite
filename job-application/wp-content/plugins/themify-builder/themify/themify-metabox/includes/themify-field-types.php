...
function themify_meta_field_image( $args ) {
    ...
    <div class="themify_clear_field <?php if( $meta_value == '' ) echo 'hide' ?>">
...
function themify_meta_field_font( $args ) {
    ...
    <div class="themify_clear_field <?php $meta_value == '' && print( 'hide' ); ?>">
    ...
    if ( is_multisite() && !is_upload_space_available() ) {
        ...
        if( '' != $args['fallback'] )
            ...
            <?php } ?>
                ...
                ?>
                <div class="plupload-upload-uic hide-if-no-js <?php echo esc_attr( $classes ); ?>" <?php echo implode( ' ', $datas ); ?> id="<?php echo esc_attr( $id ); ?>plupload-upload-ui" data-type="<?php esc_attr_e( $args['type'] ); ?>">
